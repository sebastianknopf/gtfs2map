...
class GeoJsonContext:
    ...
    def create(self) -> dict:
        ...
        context['GTFS_REALTIME_TRIP_UPDATES_METHOD'] = os.getenv('GTFS_REALTIME_TRIP_UPDATES_METHOD', 'http')
        ...
        context['GTFS_REALTIME_VEHICLE_POSITIONS_METHOD'] = os.getenv('GTFS_REALTIME_VEHICLE_POSITIONS_METHOD', 'http')
        ...
        context['GTFS_REALTIME_SERVICE_ALERTS_METHOD'] = os.getenv('GTFS_REALTIME_SERVICE_ALERTS_METHOD', 'http')
